...
def predict(summaries, X_test):
    ...
    for test in X_test:
        ...
        #         best_label = k  # 찾은 확률값의 키를 예측 레이블로 업데이트
...
if __name__ == '__main__':
    ...
    # 학습 데이터 세트만으로 summaries(평균, 표준편차, 개수)를 찾음.
    ...
    # print(df.head())
    df = cancer_dataset[column_names].head()
    print(df.head())
